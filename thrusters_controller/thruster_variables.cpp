...
float Kp, Ki, Kd, Acceptable_error, Output_min, Output_max, Integral_min, Integral_max; 
...
void loadThrusterValues() {
    ...
    auto PID_Constants = doc.FirstChildElement("vehicle")->FirstChildElement("PID_Constants");
    ...
    // Assigning PID Constants
    Kp = std::stof(PID_Constants->FirstChildElement("Kp")->GetText());
    Ki = std::stof(PID_Constants->FirstChildElement("Ki")->GetText());
    Kd = std::stof(PID_Constants->FirstChildElement("Kd")->GetText());
    Acceptable_error = std::stof(PID_Constants->FirstChildElement("Acceptable_error")->GetText());
    Output_min = std::stof(PID_Constants->FirstChildElement("Output_min")->GetText());
    Output_max = std::stof(PID_Constants->FirstChildElement("Output_max")->GetText());
    Integral_min = std::stof(PID_Constants->FirstChildElement("Integral_min")->GetText());
    Integral_max = std::stof(PID_Constants->FirstChildElement("Integral_max")->GetText());
